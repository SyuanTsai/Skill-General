...
Describe 'Canonical Standard v1 validation adapter' {
    BeforeAll {
        ...
        $script:ExpectedAuthorityCommit = 'cb5673ba2fd4a68ccaf917db43673937bec0677a'
        $script:ExpectedAuthorityArchiveSha256 = 'caf931ed55ad1ae923022eaf3137ae53eefce7b5e2c80a5708511d623a3a860b'
    ...
    It 'pins the exact inactive review authority snapshot without local deviation policy' {
