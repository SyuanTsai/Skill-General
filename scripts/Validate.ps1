...
$script:AuthorityCommit = '0e7cee9cac736f44d0b0953387e0aee723a9e24a'
$script:AuthorityArchiveSha256 = '30eebe31553a08858e59763db6fd1ef9390f31f409bd1e3d6f0a9674713a564c'
$script:AuthorityFiles = [ordered]@{
    ...
    'docs/standards/skill-repository-standard.md' = '026175f76a53304f4e5321f1a664228a5830853fd1fcf368577c60cde03798df'
    ...
    'docs/standards/schemas/standard-validation-evidence-v1.schema.json' = '1648834d04025cfeb5a9141042974fe7593f8a91ee439e4e338db4b7d4d8af61'
    ...
    'scripts/Invoke-StandardValidation.ps1' = '9973bcd6facb9013d5cd32e4e9eb924c5cb1cd7ad69461b2604d4f9699298e78'
