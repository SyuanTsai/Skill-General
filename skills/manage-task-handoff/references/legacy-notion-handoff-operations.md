...
1. Query `Context Handoffs` by exact Task Key. Zero matches means no legacy view; more than one is an integrity conflict. Read all related unmerged changes for the sole matching main record.
